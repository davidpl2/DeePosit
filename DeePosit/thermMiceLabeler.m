%Author David Peles
function varargout = thermMiceLabeler(varargin)
% THERMMICELABELER MATLAB code for thermMiceLabeler.fig
%      THERMMICELABELER, by itself, creates a new THERMMICELABELER or raises the existing
%      singleton*.
%
%      H = THERMMICELABELER returns the handle to a new THERMMICELABELER or the handle to
%      the existing singleton*  .
%
%      THERMMICELABELER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in THERMMICELABELER.M with the given input arguments.
%
%      THERMMICELABELER('Property','Value',...) creates a new THERMMICELABELER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before thermMiceLabeler_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to thermMiceLabeler_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help thermMiceLabeler

% Last Modified by GUIDE v2.5 28-Feb-2024 09:16:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @thermMiceLabeler_OpeningFcn, ...
    'gui_OutputFcn',  @thermMiceLabeler_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before thermMiceLabeler is made visible.
function thermMiceLabeler_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to thermMiceLabeler (see VARARGIN)

% Choose default command line output for thermMiceLabeler
...
% UIWAIT makes thermMiceLabeler wait for user response (see UIRESUME)
...
function varargout = thermMiceLabeler_OutputFcn(hObject, eventdata, handles)
